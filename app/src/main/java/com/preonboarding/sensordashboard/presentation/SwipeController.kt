...
class SwipeController() :
    ...
    private fun drawButtons(
        ...
        if (buttonsShowedState === ButtonState.LEFT_VISIBLE) {
            ...
            p.color =
                Color.parseColor("#ff0000") //Paint 객체 컬러 지정, setColor 메서드는 int형 인자를 매개변수로 받기 때문에 string 형태의 색상을 Color 클래스의 parseColor 메서드를 이용해 int형으로 바꿔줌
